...
$watch('popoverOpen', function(value) {
    ...
    <button x-ref="popoverButton" @click="popoverOpen=!popoverOpen"
        class="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border border-neutral-200/70 bg-white shadow-sm hover:bg-neutral-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 active:bg-white">
    ...
    <div x-ref="popover" x-show="popoverOpen" x-init="setTimeout(function() { popoverHeightCalculate(); }, 100);" x-trap.inert="popoverOpen"
        ...
        class="absolute left-1/2 z-50 w-[300px] max-w-lg -translate-x-1/2" x-cloak>
        <div x-ref="popoverInner" x-show="popoverOpen"
            class="w-full rounded-md border border-neutral-200/70 bg-white p-4 shadow-sm">
            <div x-show="popoverArrow && popoverPosition == 'bottom'"
                ...
                <div class="h-2.5 w-2.5 origin-bottom-left rotate-45 transform rounded-sm border-l border-t bg-white">
                </div>
            </div>
            <div x-show="popoverArrow  && popoverPosition == 'top'"
                ...
                <div class="h-2.5 w-2.5 origin-top-left -rotate-45 transform rounded-sm border-b border-l bg-white">
                </div>
            </div>
            <div class="grid gap-4">
                ...
                <div class="grid gap-2">
                    <div class="grid grid-cols-3 items-center gap-4">
                        ...
                        <input
                            class="border-input ring-offset-background placeholder:text-muted-foreground col-span-2 flex h-8 w-full rounded-md border border-primary-600 bg-transparent px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium hover:border-pink-500 focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-neutral-400 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                            id="width" value="100%">
                    </div>
                    <div class="grid grid-cols-3 items-center gap-4"><label
                            class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
